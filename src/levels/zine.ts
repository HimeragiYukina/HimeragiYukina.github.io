 ...
 * my modern poetry class. The ASCII mascots come from 東方AA纏メ処 (modified
 * for the zine — see Works Cited). The scanned Hagiwara Kyōjirō poem from
 * the print zine is cited rather than reproduced.
 */
  ...
  return makeArticleLevel(router, 'zine', 'THE ZINE', (inner) => {
    inner.innerHTML = `
      ...
      <p class="abstract">A zine for my modern poetry class — structural beauty, scientific diagrams,
        and ASCII art, recreated for the web.</p>
      <div class="rule"></div>
      ...
      <div class="zine-paper">
        ...
        <p>
          ...
          scientific diagrams, and ASCII art generated by computer programs!
        </p>
      </div>
      ...
      <div class="zine-paper">
        ...
        <p class="zine-note">(In the original print layout, a full-page ASCII meteor shower rains
          between the stanzas as a girl watches from a bench.)</p>
      </div>
      ...
      <div class="zine-paper">
        ...
        <p class="zine-note">(The print zine compresses a bonfire scene into a wall of dyed symbols
          between the stanzas — a world smashed to ASCII.)</p>
      </div>
      ...
      <div class="zine-paper">
        <h2>Postscript</h2>
        <p>
          Creating poems with special structures, tree diagrams, and ASCII art for this zine has eaten
          away a huge chunk of my time. But it was so enjoyable that I even forgot to sleep. I probably
          spent more time adjusting the ASCII art than writing words, since I consider these
